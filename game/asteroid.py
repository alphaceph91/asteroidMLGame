...
class Asteroid:
    def __init__(self, width, height):
        ...
        #increasing vertical speed range for added challenge
        self.vel_y = random.randint(3, 8)
        #adding horizontal movement with a random direction and speed
    ...
    def move(self):
        self.y += self.vel_y
        self.x += self.vel_x
        #bouncing horizontally off the screen edges
